...
VALUES
  ('FCI-001', 'Rice', 10000, NULL, NULL),
  ('FCI-001', 'Wheat', 7000, NULL, NULL),
  ('FCI-001', 'Dal', 2000, NULL, NULL),
  ('FCI-001', 'Sugar', 2000, NULL, NULL),
  ('FCI-001', 'Cooking Oil', 1000, NULL, NULL),
  ('FCI-001', 'Kerosene', 1000, NULL, NULL)
...
VALUES
  ...
  ('exception-ration-card-hash', 'Rice', '2026-06', 15, 0, 15, TRUE),
  ('demo-ration-card-hash', 'Rice', '2026-07', 25, 0, 25, TRUE),
  ('demo-ration-card-hash', 'Wheat', '2026-07', 10, 0, 10, TRUE),
  ('exception-ration-card-hash', 'Rice', '2026-07', 15, 0, 15, TRUE)
